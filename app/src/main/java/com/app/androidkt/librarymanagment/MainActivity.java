...
import com.app.androidkt.librarymanagment.repository.BookRepository;
import com.app.androidkt.librarymanagment.repository.UserRepository;
import com.app.androidkt.librarymanagment.ui.UserAdapter;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_update:
                userRepository.updateAddressByState(state, "Main Street").observe(this, new Observer<Long>() {
                    @Override
